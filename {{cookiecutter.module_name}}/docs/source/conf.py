...
releases_release_uri = "https://github.com/{{cookiecutter.github_name}}/{{cookiecutter.github_repo}}/tree/%s"
releases_issue_uri = "https://github.com/{{cookiecutter.github_name}}/{{cookiecutter.github_repo}}/issues/%s"

# General information about the project.
project = '{{cookiecutter.module_display_name}}'
copyright = '%d {{cookiecutter.full_name}}' % year
...
html_theme_options = {
    ...
    'github_repo': '{{cookiecutter.module_name}}',
    'github_button': False,
    'github_banner': True,
